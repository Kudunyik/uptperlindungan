...
<head>
    ...
    <body>
        <div class="table-responsive">
               <table id="dt-penilaian-afektif" class="table table-bordered table-striped" cellspacing="0" width="100%">
            <thead>
                <tr class="b-all text-center">
                <th class="b-all font-weight-bold text-center" rowspan="2" style="width: 1%; padding-bottom: 2em;">No Urut</th>
                <th class="b-all font-weight-bold text-center" rowspan="2" style="width: 1%; padding-bottom: 2em;">Nomor Berkas</th>
